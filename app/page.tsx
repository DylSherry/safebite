      ...
      <main className="flex-1 overflow-y-auto bg-emerald-950">
        ...
        <section className="px-8 pt-14 pb-12 border-b border-emerald-800/60">
          <div className="max-w-3xl">
            ...
            <form onSubmit={handlePromptSearch} className="mb-8 max-w-xl">
              <label className="block text-xs font-semibold text-emerald-400 mb-2 tracking-wide uppercase">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder='e.g. "dairy-free snacks under R50"'
                  className="flex-1 rounded-lg bg-emerald-900 border border-emerald-700 px-4 py-2.5 text-sm text-white placeholder-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                />
                <button
                  type="submit"
                  disabled={!searchPrompt.trim()}
                  className="rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:opacity-40 disabled:cursor-not-allowed px-5 py-2.5 text-sm font-semibold text-white transition-colors shrink-0"
                >
                  Search
                </button>
              </div>
              <p className="mt-2 text-xs text-emerald-500">Describe what you need — allergens, price range, category, and more.</p>
            </form>
